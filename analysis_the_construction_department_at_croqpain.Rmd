...
croqpain_transformed <- croqpain

# Apply transformations to 'croqpain_transformed'
# For example, if you want to apply a log transformation to the 'PRICE' column:
croqpain_transformed$PRICE_log <- log(croqpain_transformed$PRICE + 0.01)
